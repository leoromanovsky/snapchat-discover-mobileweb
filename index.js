...
var Journey = (function () {
    function Journey(activityId, instagramIds, encodedPolyline) {
...
var FullPageManager = (function () {
    ...
    FullPageManager.prototype.dynamicSection = function () {
        var that = this;
        var slides = journeys.map(function (j) {
